...
public final class LogTailRequest extends Table {
  public static LogTailRequest getRootAsLogTailRequest(ByteBuffer _bb) { return getRootAsLogTailRequest(_bb, new LogTailRequest()); }
  public static LogTailRequest getRootAsLogTailRequest(ByteBuffer _bb, LogTailRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public LogTailRequest __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static void startLogTailRequest(FlatBufferBuilder builder) { builder.startObject(2); }
