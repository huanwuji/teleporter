...
public final class AtomicKV extends Table {
    public static AtomicKV getRootAsAtomicKV(ByteBuffer _bb) {
        return getRootAsAtomicKV(_bb, new AtomicKV());
    }

    public static AtomicKV getRootAsAtomicKV(ByteBuffer _bb, AtomicKV obj) {
        _bb.order(ByteOrder.LITTLE_ENDIAN);
        return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb));
    }

    public AtomicKV __init(int _i, ByteBuffer _bb) {
        bb_pos = _i;
        bb = _bb;
        return this;
    }
    ...
    public ByteBuffer expectAsByteBuffer() {
    ...
    public ByteBuffer updateAsByteBuffer() {
    ...
    public static void startAtomicKV(FlatBufferBuilder builder) {
        builder.startObject(3);
    }
    ...
    public static void addExpect(FlatBufferBuilder builder, int expectOffset) {
        builder.addOffset(1, expectOffset, 0);
    }

    public static void addUpdate(FlatBufferBuilder builder, int updateOffset) {
        builder.addOffset(2, updateOffset, 0);
    }
