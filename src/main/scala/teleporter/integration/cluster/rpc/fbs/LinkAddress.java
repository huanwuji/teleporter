...
public final class LinkAddress extends Table {
  public static LinkAddress getRootAsLinkAddress(ByteBuffer _bb) { return getRootAsLinkAddress(_bb, new LinkAddress()); }
  public static LinkAddress getRootAsLinkAddress(ByteBuffer _bb, LinkAddress obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public LinkAddress __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static void startLinkAddress(FlatBufferBuilder builder) { builder.startObject(4); }
