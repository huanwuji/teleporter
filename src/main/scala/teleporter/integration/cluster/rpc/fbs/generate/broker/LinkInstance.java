...
public final class LinkInstance extends Table {
  public static LinkInstance getRootAsLinkInstance(ByteBuffer _bb) { return getRootAsLinkInstance(_bb, new LinkInstance()); }
  public static LinkInstance getRootAsLinkInstance(ByteBuffer _bb, LinkInstance obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public LinkInstance __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public long timestamp() { int o = __offset(12); return o != 0 ? bb.getLong(o + bb_pos) : 0; }
  ...
  public static void startLinkInstance(FlatBufferBuilder builder) { builder.startObject(5); }
