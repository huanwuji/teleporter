...
public final class RpcEvent extends Table {
  public static RpcEvent getRootAsRpcEvent(ByteBuffer _bb) { return getRootAsRpcEvent(_bb, new RpcEvent()); }
  public static RpcEvent getRootAsRpcEvent(ByteBuffer _bb, RpcEvent obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public RpcEvent __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public byte body(int j) { int o = __offset(14); return o != 0 ? bb.get(__vector(o) + j * 1) : 0; }
  public int bodyLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer bodyAsByteBuffer() { return __vector_as_bytebuffer(14, 1); }
  ...
  public static int createRpcEvent(FlatBufferBuilder builder,
    ...
    RpcEvent.addMessage(builder, messageOffset);
  ...
  public static void startRpcEvent(FlatBufferBuilder builder) { builder.startObject(6); }
