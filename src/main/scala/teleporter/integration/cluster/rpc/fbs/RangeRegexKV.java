...
public final class RangeRegexKV extends Table {
    public static RangeRegexKV getRootAsRangeRegexKV(ByteBuffer _bb) {
        return getRootAsRangeRegexKV(_bb, new RangeRegexKV());
    }

    public static RangeRegexKV getRootAsRangeRegexKV(ByteBuffer _bb, RangeRegexKV obj) {
        _bb.order(ByteOrder.LITTLE_ENDIAN);
        return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb));
    }

    public RangeRegexKV __init(int _i, ByteBuffer _bb) {
        bb_pos = _i;
        bb = _bb;
        return this;
    }
    ...
    public static void startRangeRegexKV(FlatBufferBuilder builder) {
        builder.startObject(3);
    }
    ...
    public static void addStart(FlatBufferBuilder builder, int start) {
        builder.addInt(1, start, 0);
    }

    public static void addLimit(FlatBufferBuilder builder, int limit) {
        builder.addInt(2, limit, 0);
    }
